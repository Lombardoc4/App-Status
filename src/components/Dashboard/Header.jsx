...
export const ApplicationsHeader = ({ applications, deleteApps, deselectApps, selectedApps, searchInput, dateFilter }) => {
    ...
    return (
        <>
            <div className='flex gap-2 mb-8 w-full'>
                ...
                <p className='ms-auto my-auto italic text-slate-400'>{applications.length} Total Apps</p>
            </div>
