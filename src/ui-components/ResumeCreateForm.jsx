...
export default function ResumeCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setEmployment(initialValues.employment);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const promises = [];
          promises.push(
            ...employment.reduce((promises, original) => {
              promises.push(
                client.graphql({
          ...
          promises.push(
            ...education.reduce((promises, original) => {
              promises.push(
                client.graphql({
